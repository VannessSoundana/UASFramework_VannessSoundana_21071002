...
use App\Http\Controllers\NilaiVanesController;
...
Route::group(['middleware' => 'auth'], function (){
    ...
    Route::get('nilai', [NilaiVanesController::class, 'index'])->name('nilai.index');
    Route::get('cetak_nilai', [NilaiVanesController::class, 'cetak_nilai'])->name('cetak_nilai');
